  ...
  return (
    <div className="flex flex-col space-y-1 mb-4">
      <div className="w-full text-sm break-words items-center flex">
        {children}
        <span className="text-mine-shaft-600 dark:text-mine-shaft-400 mr-1 border-mine-shaft-100">
          {entry.created_by}:
        </span>
        {entry.body}
      </div>
...
function DeleteButton({ isActive }) {
  ...
  return (
    <button
      className={cx(
        'px-3 py-2 border border-mine-shaft-200 dark:border-mine-shaft-700 bg-mine-shaft-50 dark:bg-mine-shaft-800 rounded p-1 text-sm inline-flex items-center leading-4 text-mine-shaft-900 dark:text-mine-shaft-100 mb-8 transition-all',
        {
